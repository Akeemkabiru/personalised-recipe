    ...
    <nav className="md:h-[15vh] h-[10vh] w-[100vw] border-b">
      ...
      <div className="flex items-center justify-center w-full md:h-5/6 h-full">
        <div className="flex items-center justify-between w-full md:px-12 px-4 gap-4 md:gap-0">
          ...
          <div
            className={`flex md:flex-row flex-col md:items-center gap-12 md:font-semibold text-[#2C2B2B] md:relative absolute left-0  primary md:bg-white top-0 h-[100vh] w-[80vw] md:w-fit md:h-fit px-8 py-16 md:p-0 text-[16px] md:translate-x-0 transition-all duration-500 ${
